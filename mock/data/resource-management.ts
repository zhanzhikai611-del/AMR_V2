...
export const mapDefinitions: MapDefinition[] = [
  ...
  { id:'MAP-A-V19-03', name:'装配物流区', floor:'2F', source:'AMR-03 上传', status:'已发布', runtimeVersion:'V1.8', editVersion:'—', updatedAt:'今日 14:36', current:false, project:'当前运行范围', resourceSummary:'6 AMR · 14 设备', objectSummary:'34 路线 · 30 点位', owner:'张凯', scopeId:'SCOPE-2F-ASSEMBLY', scopeLabel:'2F · 装配物流区', mapVersion:'V1.9', uploadVehicle:'AMR-03' },
