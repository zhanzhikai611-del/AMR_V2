...
const deviceServiceAmrs = (deviceId: string) => catalog.value?.amrs.filter((item) => [...item.serviceDevices, ...item.serviceStations].includes(deviceId)).map((item) => item.id) ?? []
