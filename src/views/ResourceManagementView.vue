...
const meta = computed(() => ({
  ...
  devices: { eyebrow: 'DEVICE ASSETS', title: '设备列表', description: '管理发起任务请求的一拖二机械手臂站点。', action: '新增设备' },
