...
import DeviceRelationsView from '../views/DeviceRelationsView.vue'
  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'resources/amrs', redirect: '/resources/devices' },
        { path: 'resources/amrs/:id', component: ResourceDetailView, props: { kind: 'amr' }, meta: { groupId: 'resources', menuId: 'amrs', roles: ['研发人员'] } },
        { path: 'resources/devices', component: ResourceManagementView, meta: { groupId: 'resources', menuId: 'devices', roles: ['研发人员'] } },
        { path: 'resources/device-relations', component: DeviceRelationsView, meta: { groupId: 'resources', menuId: 'device-relations', roles: ['研发人员'] } },
