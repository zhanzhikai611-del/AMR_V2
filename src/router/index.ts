  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'resources/maps', component: MapLibraryView, meta: { groupId: 'resources', menuId: 'maps' } },
        { path: 'resources/maps/:id/edit', component: MapEditorView, meta: { groupId: 'resources', menuId: 'maps' } },
